...
public class ZteClient : IZteClient, IDisposable
{
  ...
  private static readonly string DEVICE_INFO_REQUEST =
      ...
      "bandwidth,cell_id,dns_mode," +
      "ecio_1,ecio_2,ecio_3,ecio_4," +
      "ip_passthrough_enabled,loginfo," +
      ...
      "monthly_drop_rx_packets,monthly_drop_tx_packets,monthly_rx_bytes,monthly_rx_packets,monthly_time," +
      "monthly_tx_bytes,monthly_tx_packets," +
      "nas_rrc_state," +
      "network_provider_fullname,network_type,ngbr_cell_info," +
      ...
      "ppp_connect_time,prefer_dns_manual," +
      "realtime_drop_rx_packets,realtime_drop_tx_packets," +
      "realtime_rx_bytes,realtime_rx_packets,realtime_rx_thrpt," +
      "realtime_tx_bytes,realtime_tx_packets,realtime_tx_thrpt," +
      "rmcc,rmnc," +
      "rscp_1,rscp_2,rscp_3,rscp_4," +
      "standby_dns_manual," +
      "total_drop_rx_packets,total_drop_tx_packets," +
      "total_rx_bytes,total_rx_packets,total_time,total_tx_bytes,total_tx_packets," +
